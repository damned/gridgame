...
/* Generated by Opal 0.10.3 */
Opal.modules["lib/actors/actor"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$attr_reader', '$x', '$y', '$==', '$reject', '$whats_at', '$position', '$[]', '$send', '$%', '$+', '$to_c', '$move', '$private', '$new', '$ok?']);
  return (function($base, $super) {
    function $Actor(){};
    var self = $Actor = $klass($base, $super, 'Actor', $Actor);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16, TMP_17, TMP_18;

    def.position = def.direction_index = nil;
    self.$attr_reader("position");

    Opal.cdecl($scope, 'Directions', ["right", "down", "left", "up"]);

    Opal.defn(self, '$initialize', TMP_1 = function $$initialize(position) {
      var self = this;
    ...
    Opal.defn(self, '$x', TMP_2 = function $$x() {
      var self = this;

      return self.position.$x();
    }, TMP_2.$$arity = 0);

    Opal.defn(self, '$y', TMP_3 = function $$y() {
      var self = this;

      return self.position.$y();
    }, TMP_3.$$arity = 0);

    Opal.defn(self, '$at?', TMP_4 = function(pos) {
      var self = this;

      return self.position['$=='](pos);
    }, TMP_4.$$arity = 1);

    Opal.defn(self, '$move_here_ok?', TMP_5 = function(mover) {
      var self = this;

      return true;
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$player?', TMP_6 = function() {
      var self = this;

      return false;
    }, TMP_6.$$arity = 0);

    Opal.defn(self, '$whats_here_in', TMP_8 = function $$whats_here_in(game_area) {
      var $a, $b, TMP_7, self = this;

      return ($a = ($b = game_area.$whats_at(self.$position())).$reject, $a.$$p = (TMP_7 = function(thing){var self = TMP_7.$$s || this;
if (thing == null) thing = nil;
      return thing['$=='](self)}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7), $a).call($b);
    }, TMP_8.$$arity = 1);

    Opal.defn(self, '$tick', TMP_9 = function $$tick(area) {
      var $a, $b, self = this, direction = nil;

      direction = $scope.get('Directions')['$[]'](self.direction_index);
      return (function() {while (!((($b = area.$send(direction, self)) !== nil && $b != null && (!$b.$$is_boolean || $b == true)))) {
      self.direction_index = ($rb_plus(self.direction_index, 1))['$%'](4);
      direction = $scope.get('Directions')['$[]'](self.direction_index);}; return nil; })();
    }, TMP_9.$$arity = 1);

    Opal.defn(self, '$post_tick', TMP_10 = function $$post_tick(area) {
      var self = this;

      return nil;
    }, TMP_10.$$arity = 1);

    Opal.defn(self, '$takeable?', TMP_11 = function() {
      var self = this;
    ...
    Opal.defn(self, '$to_c', TMP_13 = function $$to_c() {
      var self = this;

      return "a";
    }, TMP_13.$$arity = 0);

    Opal.defn(self, '$left', TMP_14 = function $$left(area) {
      var self = this;

      return self.$move(area, -1, 0);
    }, TMP_14.$$arity = 1);

    Opal.defn(self, '$right', TMP_15 = function $$right(area) {
      var self = this;

      return self.$move(area, 1, 0);
    }, TMP_15.$$arity = 1);

    Opal.defn(self, '$up', TMP_16 = function $$up(area) {
      var self = this;

      return self.$move(area, 0, -1);
    }, TMP_16.$$arity = 1);

    Opal.defn(self, '$down', TMP_17 = function $$down(area) {
      var self = this;
    ...
    return (Opal.defn(self, '$move', TMP_18 = function $$move(area, dx, dy) {
      var $a, self = this, newpos = nil;

      newpos = $scope.get('Position').$new($rb_plus(self.position.$x(), dx), $rb_plus(self.position.$y(), dy));
      if ((($a = area['$ok?'](newpos, self)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return false
      };
      self.position = newpos;
      return true;
    }, TMP_18.$$arity = 3), nil) && 'move';
  })($scope.base, null)
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/actors/static_actor"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  self.$require("lib/actors/static_actor"+ '/../' + "actor");
  return (function($base, $super) {
    function $StaticActor(){};
    var self = $StaticActor = $klass($base, $super, 'StaticActor', $StaticActor);

    var def = self.$$proto, $scope = self.$$scope, TMP_1;

    return (Opal.defn(self, '$tick', TMP_1 = function $$tick(area) {
      var self = this;

      return nil;
    }, TMP_1.$$arity = 1), nil) && 'tick'
  })($scope.base, $scope.get('Actor'));
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/actors/blocker"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  self.$require("lib/actors/blocker"+ '/../' + "static_actor");
  return (function($base, $super) {
    function $Blocker(){};
    var self = $Blocker = $klass($base, $super, 'Blocker', $Blocker);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2;

    Opal.defn(self, '$move_here_ok?', TMP_1 = function(mover) {
      var self = this;

      return false;
    }, TMP_1.$$arity = 1);

    return (Opal.defn(self, '$to_c', TMP_2 = function $$to_c() {
      var self = this;

      return "B";
    }, TMP_2.$$arity = 0), nil) && 'to_c';
  })($scope.base, $scope.get('StaticActor'));
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/actors/charming_chain"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  self.$require("lib/actors/charming_chain"+ '/../' + "static_actor");
  return (function($base, $super) {
    function $CharmingChain(){};
    var self = $CharmingChain = $klass($base, $super, 'CharmingChain', $CharmingChain);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3;

    Opal.defn(self, '$to_c', TMP_1 = function $$to_c() {
      var self = this;

      return "c";
    }, TMP_1.$$arity = 0);

    Opal.defn(self, '$takeable?', TMP_2 = function() {
      var self = this;

      return true;
    }, TMP_2.$$arity = 0);

    return (Opal.defn(self, '$to_s', TMP_3 = function $$to_s() {
      var self = this;

      return "charming chain";
    }, TMP_3.$$arity = 0), nil) && 'to_s';
  })($scope.base, $scope.get('StaticActor'));
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/actors/destination"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  self.$require("lib/actors/destination"+ '/../' + "static_actor");
  return (function($base, $super) {
    function $Destination(){};
    var self = $Destination = $klass($base, $super, 'Destination', $Destination);

    var def = self.$$proto, $scope = self.$$scope, TMP_1;

    return (Opal.defn(self, '$to_c', TMP_1 = function $$to_c() {
      var self = this;

      return "X";
    }, TMP_1.$$arity = 0), nil) && 'to_c'
  })($scope.base, $scope.get('StaticActor'));
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/actors/attribute_builder"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$generate_moved_here_events', '$private', '$whats_at', '$each', '$moved_here', '$reject', '$include?', '$increase_attribute']);
  self.$require("lib/actors/attribute_builder"+ '/../' + "static_actor");
  return (function($base, $super) {
    function $AttributeBuilder(){};
    var self = $AttributeBuilder = $klass($base, $super, 'AttributeBuilder', $AttributeBuilder);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_7, TMP_8;

    def.position = def.attribute = nil;
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize(position) {
      var $a, $b, self = this, $iter = TMP_1.$$p, $yield = $iter || nil;

      TMP_1.$$p = null;
      self.attribute = "experience";
      self.last_here = [self];
      return ($a = ($b = self, Opal.find_super_dispatcher(self, 'initialize', TMP_1, false)), $a.$$p = null, $a).call($b, position);
    }, TMP_1.$$arity = 1);

    Opal.defn(self, '$move_here_ok?', TMP_2 = function(mover) {
      var self = this;

      return true;
    }, TMP_2.$$arity = 1);

    Opal.defn(self, '$post_tick', TMP_3 = function $$post_tick(area) {
      var self = this;

      return self.$generate_moved_here_events(area);
    }, TMP_3.$$arity = 1);

    Opal.defn(self, '$to_c', TMP_4 = function $$to_c() {
      var self = this;
    ...
    Opal.defn(self, '$generate_moved_here_events', TMP_7 = function $$generate_moved_here_events(area) {
      var $a, $b, TMP_5, $c, $d, TMP_6, self = this, actors_here = nil;

      actors_here = area.$whats_at(self.position);
      ($a = ($b = ($c = ($d = actors_here).$reject, $c.$$p = (TMP_6 = function(actor){var self = TMP_6.$$s || this;
        if (self.last_here == null) self.last_here = nil;
if (actor == null) actor = nil;
      return self.last_here['$include?'](actor)}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6), $c).call($d)).$each, $a.$$p = (TMP_5 = function(actor){var self = TMP_5.$$s || this;
if (actor == null) actor = nil;
      return self.$moved_here(actor)}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5), $a).call($b);
      return self.last_here = actors_here;
    }, TMP_7.$$arity = 1);

    return (Opal.defn(self, '$moved_here', TMP_8 = function $$moved_here(actor) {
      var self = this;

      return actor.$increase_attribute(self.attribute, 20);
    }, TMP_8.$$arity = 1), nil) && 'moved_here';
  })($scope.base, $scope.get('StaticActor'));
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/attributes/experience"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  ...
  Opal.add_stubs(['$+']);
  return (function($base) {
    var $Attributes, self = $Attributes = $module($base, 'Attributes');

    var def = self.$$proto, $scope = self.$$scope;

    (function($base, $super) {
      function $Experience(){};
      var self = $Experience = $klass($base, $super, 'Experience', $Experience);
      ...
      Opal.defn(self, '$tick', TMP_2 = function $$tick(area) {
        var self = this;

        return self.xp = $rb_plus(self.xp, 1);
      }, TMP_2.$$arity = 1);

      Opal.defn(self, '$increase_by', TMP_3 = function $$increase_by(amount) {
        var self = this;

        return self.xp = $rb_plus(self.xp, amount);
      }, TMP_3.$$arity = 1);

      return (Opal.defn(self, '$to_s', TMP_4 = function $$to_s() {
        var self = this;
...
/* Generated by Opal 0.10.3 */
Opal.modules["lib/attributes"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;

  return self.$require("lib/attributes"+ '/../' + "attributes/experience")
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/inventory"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$+', '$empty?', '$join', '$map', '$to_proc']);
  return (function($base, $super) {
    function $Inventory(){};
    var self = $Inventory = $klass($base, $super, 'Inventory', $Inventory);
    ...
    Opal.defn(self, '$add_all', TMP_2 = function $$add_all(objects) {
      var self = this;

      return self.objects = $rb_plus(self.objects, objects);
    }, TMP_2.$$arity = 1);

    return (Opal.defn(self, '$to_s', TMP_3 = function $$to_s() {
      var $a, $b, self = this, inventory_s = nil;

      if ((($a = self.objects['$empty?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "-"};
      return inventory_s = ($a = ($b = self.objects).$map, $a.$$p = "to_s".$to_proc(), $a).call($b).$join(", ");
    }, TMP_3.$$arity = 0), nil) && 'to_s';
  })($scope.base, null)
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/actors/player"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$new', '$each', '$tick', '$values', '$add_all', '$inventory', '$take_all', '$position', '$increase_by', '$[]', '$attributes', '$join', '$attributes_status', '$to_s', '$private', '$attr_reader', '$map', '$to_proc']);
  self.$require("lib/actors/player"+ '/../' + "actor");
  self.$require("lib/actors/player"+ '/../' + "../attributes");
  self.$require("lib/actors/player"+ '/../' + "../inventory");
  return (function($base, $super) {
    function $Player(){};
    ...
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize(position) {
      ...
      TMP_1.$$p = null;
      self.attributes = $hash2(["experience"], {"experience": (($scope.get('Attributes')).$$scope.get('Experience')).$new()});
      self.inventory = $scope.get('Inventory').$new();
      return ($a = ($b = self, Opal.find_super_dispatcher(self, 'initialize', TMP_1, false)), $a.$$p = null, $a).call($b, position);
    }, TMP_1.$$arity = 1);

    Opal.defn(self, '$tick', TMP_3 = function $$tick(area) {
      var $a, $b, TMP_2, self = this;

      return ($a = ($b = self.attributes.$values()).$each, $a.$$p = (TMP_2 = function(a){var self = TMP_2.$$s || this;
if (a == null) a = nil;
      return a.$tick(area)}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $a).call($b);
    }, TMP_3.$$arity = 1);

    Opal.defn(self, '$take', TMP_4 = function $$take(area) {
      var self = this;

      return self.$inventory().$add_all(area.$take_all(self.$position()));
    }, TMP_4.$$arity = 1);

    Opal.defn(self, '$increase_attribute', TMP_5 = function $$increase_attribute(key, amount) {
      var self = this;

      return self.$attributes()['$[]'](key).$increase_by(20);
    }, TMP_5.$$arity = 2);

    Opal.defn(self, '$to_c', TMP_6 = function $$to_c() {
      var self = this;
    ...
    Opal.defn(self, '$player?', TMP_8 = function() {
      var self = this;

      return true;
    }, TMP_8.$$arity = 0);

    Opal.defn(self, '$status', TMP_9 = function $$status() {
      var self = this;

      return [self.$attributes_status(), self.$inventory().$to_s()].$join(" Carrying: ");
    }, TMP_9.$$arity = 0);

    self.$private();

    self.$attr_reader("attributes", "inventory");

    return (Opal.defn(self, '$attributes_status', TMP_10 = function $$attributes_status() {
      var $a, $b, self = this;

      return ($a = ($b = self.attributes.$values()).$map, $a.$$p = "to_s".$to_proc(), $a).call($b).$join(" ");
    }, TMP_10.$$arity = 0), nil) && 'attributes_status';
  })($scope.base, $scope.get('Actor'));
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/actors"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;

  self.$require("lib/actors"+ '/../' + "actors/actor");
  self.$require("lib/actors"+ '/../' + "actors/blocker");
  self.$require("lib/actors"+ '/../' + "actors/charming_chain");
  self.$require("lib/actors"+ '/../' + "actors/destination");
  self.$require("lib/actors"+ '/../' + "actors/attribute_builder");
  self.$require("lib/actors"+ '/../' + "actors/static_actor");
  return self.$require("lib/actors"+ '/../' + "actors/player");
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/game_area"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  function $rb_ge(lhs, rhs) {
  ...
  Opal.add_stubs(['$<<', '$right', '$left', '$up', '$down', '$map', '$join', '$find', '$==', '$x', '$y', '$nil?', '$to_c', '$column_indices', '$row_indices', '$x_ok?', '$y_ok?', '$all?', '$move_here_ok?', '$whats_at', '$select', '$to_proc', '$each', '$delete', '$position', '$private', '$-', '$>=', '$<']);
  return (function($base, $super) {
    function $GameArea(){};
    var self = $GameArea = $klass($base, $super, 'GameArea', $GameArea);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_11, TMP_13, TMP_15, TMP_17, TMP_18, TMP_19, TMP_20, TMP_21;

    def.actors = def.rows = def.row_size = def.row_count = nil;
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize(row_size, row_count) {
      var self = this;
    ...
    Opal.defn(self, '$add', TMP_2 = function $$add(actor) {
      var self = this;

      return self.actors['$<<'](actor);
    }, TMP_2.$$arity = 1);

    Opal.defn(self, '$rows', TMP_3 = function $$rows() {
      var self = this;

      return self.rows;
    }, TMP_3.$$arity = 0);

    Opal.defn(self, '$right', TMP_4 = function $$right(actor) {
      var self = this;

      return actor.$right(self);
    }, TMP_4.$$arity = 1);

    Opal.defn(self, '$left', TMP_5 = function $$left(actor) {
      var self = this;

      return actor.$left(self);
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$up', TMP_6 = function $$up(actor) {
      var self = this;

      return actor.$up(self);
    }, TMP_6.$$arity = 1);

    Opal.defn(self, '$down', TMP_7 = function $$down(actor) {
      var self = this;

      return actor.$down(self);
    }, TMP_7.$$arity = 1);

    Opal.defn(self, '$to_a', TMP_11 = function $$to_a() {
      var $a, $b, TMP_8, self = this;

      return ($a = ($b = self.$row_indices()).$map, $a.$$p = (TMP_8 = function(y){var self = TMP_8.$$s || this, $c, $d, TMP_9;
if (y == null) y = nil;
      return ($c = ($d = self.$column_indices()).$map, $c.$$p = (TMP_9 = function(x){var self = TMP_9.$$s || this, $e, $f, TMP_10, actor = nil;
          if (self.actors == null) self.actors = nil;
if (x == null) x = nil;
        actor = ($e = ($f = self.actors).$find, $e.$$p = (TMP_10 = function(a){var self = TMP_10.$$s || this, $g;
if (a == null) a = nil;
          return (($g = a.$x()['$=='](x)) ? a.$y()['$=='](y) : a.$x()['$=='](x))}, TMP_10.$$s = self, TMP_10.$$arity = 1, TMP_10), $e).call($f);
          if ((($e = actor['$nil?']()) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
            return "."
            } else {
            return actor.$to_c()
          };}, TMP_9.$$s = self, TMP_9.$$arity = 1, TMP_9), $c).call($d).$join("")}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8), $a).call($b);
    }, TMP_11.$$arity = 0);

    Opal.defn(self, '$ok?', TMP_13 = function(pos, actor) {
      var $a, $b, $c, TMP_12, self = this;

      return ($a = ($b = self['$x_ok?'](pos.$x()), $b !== false && $b !== nil && $b != null ?self['$y_ok?'](pos.$y()) : $b), $a !== false && $a !== nil && $a != null ?($b = ($c = self.$whats_at(pos))['$all?'], $b.$$p = (TMP_12 = function(actor_here){var self = TMP_12.$$s || this;
if (actor_here == null) actor_here = nil;
      return actor_here['$move_here_ok?'](actor)}, TMP_12.$$s = self, TMP_12.$$arity = 1, TMP_12), $b).call($c) : $a);
    }, TMP_13.$$arity = 2);

    Opal.defn(self, '$take_all', TMP_15 = function $$take_all(position) {
      var $a, $b, $c, TMP_14, self = this, objects = nil;

      objects = ($a = ($b = self.$whats_at(position)).$select, $a.$$p = "takeable?".$to_proc(), $a).call($b);
      ($a = ($c = objects).$each, $a.$$p = (TMP_14 = function(o){var self = TMP_14.$$s || this;
        if (self.actors == null) self.actors = nil;
if (o == null) o = nil;
      return self.actors.$delete(o)}, TMP_14.$$s = self, TMP_14.$$arity = 1, TMP_14), $a).call($c);
      return objects;
    }, TMP_15.$$arity = 1);

    Opal.defn(self, '$whats_at', TMP_17 = function $$whats_at(position) {
      var $a, $b, TMP_16, self = this;

      return ($a = ($b = self.actors).$select, $a.$$p = (TMP_16 = function(actor){var self = TMP_16.$$s || this;
if (actor == null) actor = nil;
      return actor.$position()['$=='](position)}, TMP_16.$$s = self, TMP_16.$$arity = 1, TMP_16), $a).call($b);
    }, TMP_17.$$arity = 1);

    self.$private();

    Opal.defn(self, '$column_indices', TMP_18 = function $$column_indices() {
      var self = this;

      return ($range(0, ($rb_minus(self.row_size, 1)), false));
    }, TMP_18.$$arity = 0);

    Opal.defn(self, '$row_indices', TMP_19 = function $$row_indices() {
      var self = this;

      return ($range(0, ($rb_minus(self.row_count, 1)), false));
    }, TMP_19.$$arity = 0);

    Opal.defn(self, '$x_ok?', TMP_20 = function(x) {
      var $a, self = this;

      return ($a = $rb_ge(x, 0), $a !== false && $a !== nil && $a != null ?$rb_lt(x, self.row_size) : $a);
    }, TMP_20.$$arity = 1);

    return (Opal.defn(self, '$y_ok?', TMP_21 = function(y) {
      var $a, self = this;

      return ($a = $rb_ge(y, 0), $a !== false && $a !== nil && $a != null ?$rb_lt(y, self.row_count) : $a);
    }, TMP_21.$$arity = 1), nil) && 'y_ok?';
  })($scope.base, null)
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/position"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$attr_reader', '$==', '$x', '$y']);
  return (function($base, $super) {
    function $Position(){};
    ...
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize(x, y) {
      var self = this;
    ...
    return (Opal.defn(self, '$==', TMP_2 = function(other) {
      ...
      return (($a = self.$x()['$=='](other.$x())) ? self.$y()['$=='](other.$y()) : self.$x()['$=='](other.$x()));
    }, TMP_2.$$arity = 1), nil) && '==';
  })($scope.base, null)
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/config/game_config"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$attr_reader', '$with_player_at', '$with_destination_at', '$with_size', '$place', '$private', '$[]=', '$new']);
  self.$require("lib/config/game_config"+ '/../' + "../position");
  return (function($base, $super) {
    function $GameConfig(){};
    var self = $GameConfig = $klass($base, $super, 'GameConfig', $GameConfig);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9;

    def.positions = nil;
    self.$attr_reader("width", "height", "positions");

    Opal.defn(self, '$initialize', TMP_1 = function $$initialize() {
      var self = this;

      self.positions = $hash2([], {});
      self.$with_player_at(0, 2);
      self.$with_destination_at(3, 0);
      return self.$with_size(5, 3);
    }, TMP_1.$$arity = 0);

    Opal.defn(self, '$with_size', TMP_2 = function $$with_size(w, h) {
      var self = this;
    ...
    Opal.defn(self, '$with_actor_at', TMP_3 = function $$with_actor_at(x, y) {
      var self = this;

      return self.$place("actor", x, y);
    }, TMP_3.$$arity = 2);

    Opal.defn(self, '$with_blocker_at', TMP_4 = function $$with_blocker_at(x, y) {
      var self = this;

      return self.$place("blocker", x, y);
    }, TMP_4.$$arity = 2);

    Opal.defn(self, '$with_experience_builder_at', TMP_5 = function $$with_experience_builder_at(x, y) {
      var self = this;

      return self.$place("experience_builder", x, y);
    }, TMP_5.$$arity = 2);

    Opal.defn(self, '$with_charming_chain_at', TMP_6 = function $$with_charming_chain_at(x, y) {
      var self = this;

      return self.$place("charming_chain", x, y);
    }, TMP_6.$$arity = 2);

    Opal.defn(self, '$with_player_at', TMP_7 = function $$with_player_at(x, y) {
      var self = this;

      return self.$place("player", x, y);
    }, TMP_7.$$arity = 2);

    Opal.defn(self, '$with_destination_at', TMP_8 = function $$with_destination_at(x, y) {
      var self = this;

      return self.$place("destination", x, y);
    }, TMP_8.$$arity = 2);

    self.$private();

    return (Opal.defn(self, '$place', TMP_9 = function $$place(key, x, y) {
      var self = this;

      self.positions['$[]='](key, $scope.get('Position').$new(x, y));
      return self;
    }, TMP_9.$$arity = 3), nil) && 'place';
  })($scope.base, null);
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/config/default_game_config"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$with_actor_at', '$with_charming_chain_at', '$with_experience_builder_at', '$with_blocker_at', '$with_destination_at', '$with_player_at', '$with_size']);
  self.$require("lib/config/default_game_config"+ '/../' + "game_config");
  return (function($base, $super) {
    function $DefaultGameConfig(){};
    var self = $DefaultGameConfig = $klass($base, $super, 'DefaultGameConfig', $DefaultGameConfig);
    ...
    return (Opal.defn(self, '$initialize', TMP_1 = function $$initialize() {
      ...
      return self.$with_size(20, 10).$with_player_at(1, 8).$with_destination_at(18, 1).$with_blocker_at(4, 9).$with_experience_builder_at(7, 6).$with_charming_chain_at(1, 1).$with_actor_at(14, 3);
    }, TMP_1.$$arity = 0), nil) && 'initialize'
  })($scope.base, $scope.get('GameConfig'));
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/config"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;

  self.$require("lib/config"+ '/../' + "config/game_config");
  return self.$require("lib/config"+ '/../' + "config/default_game_config");
};

/* Generated by Opal 0.10.3 */
Opal.modules["lib/gridgame"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$new', '$width', '$height', '$add_actors', '$do_display', '$input', '$==', '$quit', '$tick', '$handle_keys', '$update_actors', '$post_tick', '$whats_here', '$game_over?', '$handle_move_key', '$handle_action_key', '$each', '$values', '$has_key?', '$moves_by_key', '$check_moved', '$send', '$[]', '$player', '$actions_by_key', '$add_message', '$private', '$whats_here_in', '$empty?', '$join', '$<<', '$x', '$destination', '$y', '$game_over', '$output', '$+', '$to_a', '$message', '$status', '$keys', '$release', '$add_actor', '$positions', '$nil?', '$raise', '$[]=', '$add']);
  self.$require("lib/gridgame"+ '/../' + "actors");
  self.$require("lib/gridgame"+ '/../' + "game_area");
  self.$require("lib/gridgame"+ '/../' + "config");
  return (function($base, $super) {
    function $Gridgame(){};
    var self = $Gridgame = $klass($base, $super, 'Gridgame', $Gridgame);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_3, TMP_4, TMP_5, TMP_7, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16, TMP_17, TMP_18, TMP_19, TMP_20, TMP_21, TMP_22, TMP_23, TMP_24, TMP_25, TMP_27, TMP_28;

    def.console = def.actors = def.game_area = def.messages = nil;
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize($kwargs) {
      var self = this, console, config;
      ...
      if ((console = $kwargs.$$smap['console']) == null) {
        console = $scope.get('Console').$new()
      }
      if ((config = $kwargs.$$smap['config']) == null) {
        config = $scope.get('GameConfig').$new()
      }
      self.console = console;
      self.messages = [];
      self.game_area = $scope.get('GameArea').$new(config.$width(), config.$height());
      self.actors = $hash2([], {});
      return self.$add_actors(config);
    }, TMP_1.$$arity = -1);

    Opal.defn(self, '$start', TMP_3 = function $$start() {
      var $a, $b, TMP_2, self = this;

      self.$do_display();
      return ($a = ($b = self.console).$input, $a.$$p = (TMP_2 = function(key){var self = TMP_2.$$s || this;
if (key == null) key = nil;
      self.messages = [];
        if (key['$==']("q")) {
          return self.$quit()
    ...
    Opal.defn(self, '$tick', TMP_4 = function $$tick(key) {
      var $a, self = this;
      ...
      self.$post_tick();
      self.$whats_here();
      if ((($a = self['$game_over?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return nil
        } else {
    ...
    Opal.defn(self, '$handle_keys', TMP_5 = function $$handle_keys(key) {
      var self = this;
    ...
    Opal.defn(self, '$update_actors', TMP_7 = function $$update_actors() {
      var $a, $b, TMP_6, self = this;

      return ($a = ($b = self.actors.$values()).$each, $a.$$p = (TMP_6 = function(actor){var self = TMP_6.$$s || this;
        if (self.game_area == null) self.game_area = nil;
if (actor == null) actor = nil;
      return actor.$tick(self.game_area)}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6), $a).call($b);
    }, TMP_7.$$arity = 0);

    Opal.defn(self, '$post_tick', TMP_9 = function $$post_tick() {
      var $a, $b, TMP_8, self = this;

      return ($a = ($b = self.actors.$values()).$each, $a.$$p = (TMP_8 = function(actor){var self = TMP_8.$$s || this;
        if (self.game_area == null) self.game_area = nil;
if (actor == null) actor = nil;
      return actor.$post_tick(self.game_area)}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8), $a).call($b);
    }, TMP_9.$$arity = 0);

    Opal.defn(self, '$handle_move_key', TMP_10 = function $$handle_move_key(c) {
      var $a, self = this;

      if ((($a = self.$moves_by_key()['$has_key?'](c)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return self.$check_moved(self.game_area.$send(self.$moves_by_key()['$[]'](c), self.$player()))
        } else {
        return nil
      };
    }, TMP_10.$$arity = 1);

    Opal.defn(self, '$handle_action_key', TMP_11 = function $$handle_action_key(c) {
      var $a, self = this;

      if ((($a = self.$actions_by_key()['$has_key?'](c)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return self.$player().$send(self.$actions_by_key()['$[]'](c), self.game_area)
        } else {
        return nil
      };
    }, TMP_11.$$arity = 1);

    Opal.defn(self, '$check_moved', TMP_12 = function $$check_moved(moved) {
      var self = this;

      if (moved !== false && moved !== nil && moved != null) {
        return nil
        } else {
        return self.$add_message("Cannot move there")
      };
    }, TMP_12.$$arity = 1);

    self.$private();

    Opal.defn(self, '$whats_here', TMP_13 = function $$whats_here() {
      var $a, self = this, things_here = nil;

      things_here = self.$player().$whats_here_in(self.game_area);
      if ((($a = things_here['$empty?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return nil
        } else {
        return self.$add_message("You can see: " + (things_here.$join(", ")))
      };
    }, TMP_13.$$arity = 0);

    Opal.defn(self, '$add_message', TMP_14 = function $$add_message(message) {
      var self = this;

      return self.messages['$<<'](message);
    }, TMP_14.$$arity = 1);

    Opal.defn(self, '$message', TMP_15 = function $$message() {
      var self = this;

      return self.messages.$join(". ");
    }, TMP_15.$$arity = 0);

    Opal.defn(self, '$player', TMP_16 = function $$player() {
      var self = this;

      return self.actors['$[]']("player");
    }, TMP_16.$$arity = 0);

    Opal.defn(self, '$destination', TMP_17 = function $$destination() {
      var self = this;

      return self.actors['$[]']("destination");
    }, TMP_17.$$arity = 0);

    Opal.defn(self, '$game_over?', TMP_18 = function() {
      var $a, $b, self = this;

      if ((($a = (($b = self.$destination().$x()['$=='](self.$player().$x())) ? self.$destination().$y()['$=='](self.$player().$y()) : self.$destination().$x()['$=='](self.$player().$x()))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        self.$game_over("Reached destination");
        return true;};
      return false;
    }, TMP_18.$$arity = 0);

    Opal.defn(self, '$moves_by_key', TMP_19 = function $$moves_by_key() {
      var self = this;

      return $hash2(["left", "right", "down", "up"], {"left": "left", "right": "right", "down": "down", "up": "up"});
    }, TMP_19.$$arity = 0);

    Opal.defn(self, '$actions_by_key', TMP_20 = function $$actions_by_key() {
      var self = this;

      return $hash2(["t"], {"t": "take"});
    }, TMP_20.$$arity = 0);

    Opal.defn(self, '$do_display', TMP_21 = function $$do_display() {
      var self = this;

      return self.console.$output($rb_plus(self.game_area.$to_a(), [self.$message(), self.$status(), self.$keys()]));
    }, TMP_21.$$arity = 0);

    Opal.defn(self, '$status', TMP_22 = function $$status() {
      var self = this;

      return "Player: " + (self.$player().$status());
    }, TMP_22.$$arity = 0);

    Opal.defn(self, '$quit', TMP_23 = function $$quit() {
      var self = this;

      return self.$game_over("Quitted game");
    }, TMP_23.$$arity = 0);

    Opal.defn(self, '$game_over', TMP_24 = function $$game_over(message) {
      var self = this;

      self.console.$output([message]);
      return self.console.$release();
    }, TMP_24.$$arity = 1);

    Opal.defn(self, '$keys', TMP_25 = function $$keys() {
      var self = this;

      return "Move: arrows, Take: t, Quit: q";
    }, TMP_25.$$arity = 0);

    Opal.cdecl($scope, 'ActorClasses', $hash2(["player", "destination", "actor", "blocker", "experience_builder", "charming_chain"], {"player": $scope.get('Player'), "destination": $scope.get('Destination'), "actor": $scope.get('Actor'), "blocker": $scope.get('Blocker'), "experience_builder": $scope.get('AttributeBuilder'), "charming_chain": $scope.get('CharmingChain')}));

    Opal.defn(self, '$add_actors', TMP_27 = function $$add_actors(config) {
      var $a, $b, TMP_26, self = this;

      return ($a = ($b = config.$positions()).$each, $a.$$p = (TMP_26 = function(key, position){var self = TMP_26.$$s || this;
if (key == null) key = nil;if (position == null) position = nil;
      return self.$add_actor($scope.get('ActorClasses')['$[]'](key), key, position)}, TMP_26.$$s = self, TMP_26.$$arity = 2, TMP_26), $a).call($b);
    }, TMP_27.$$arity = 1);

    return (Opal.defn(self, '$add_actor', TMP_28 = function $$add_actor(actor_class, key, position) {
      var $a, self = this, actor = nil;

      if ((($a = actor_class['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        self.$raise("unknown actor type: " + (key))};
      actor = actor_class.$new(position);
      self.actors['$[]='](key, actor);
      return self.game_area.$add(actor);
    }, TMP_28.$$arity = 3), nil) && 'add_actor';
  })($scope.base, null);
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$each', '$puts', '$getc', '$to_s', '$start', '$new', '$run']);
  self.$require("lib/ui/gridgame_opal_runner"+ '/../' + "../gridgame");
  self.$require("lib/ui/gridgame_opal_runner"+ '/../' + "../config/default_game_config");
  (function($base, $super) {
    function $OpalConsole(){};
    var self = $OpalConsole = $klass($base, $super, 'OpalConsole', $OpalConsole);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_3, TMP_4, TMP_5;

    def.release = nil;
    Opal.defn(self, '$intitialize', TMP_1 = function $$intitialize() {
      var self = this;

      return self.release = false;
    }, TMP_1.$$arity = 0);

    Opal.defn(self, '$output', TMP_3 = function $$output(lines) {
      var $a, $b, TMP_2, self = this;

      return ($a = ($b = lines).$each, $a.$$p = (TMP_2 = function(line){var self = TMP_2.$$s || this;
if (line == null) line = nil;
      return $scope.get('STDOUT').$puts(line)}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $a).call($b);
    }, TMP_3.$$arity = 1);

    Opal.defn(self, '$input', TMP_4 = function $$input() {
      var $a, $b, self = this, $iter = TMP_4.$$p, $yield = $iter || nil, c = nil;

      TMP_4.$$p = null;
      while ((($b = true) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
      c = $scope.get('STDIN').$getc();
      Opal.yield1($yield, c.$to_s());
      if ((($b = self.release) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
        break;};};
    }, TMP_4.$$arity = 0);

    return (Opal.defn(self, '$release', TMP_5 = function $$release() {
      var self = this;

      return self.release = true;
    }, TMP_5.$$arity = 0), nil) && 'release';
  })($scope.base, null);
  (function($base, $super) {
    function $GridgameOpalRunner(){};
    var self = $GridgameOpalRunner = $klass($base, $super, 'GridgameOpalRunner', $GridgameOpalRunner);

    var def = self.$$proto, $scope = self.$$scope, TMP_6;

    return (Opal.defn(self, '$run', TMP_6 = function $$run(config) {
      var self = this;

      if (config == null) {
        config = $scope.get('DefaultGameConfig').$new();
      }
      self.$puts("there");
      return $scope.get('Gridgame').$new($hash2(["config", "console"], {"config": config, "console": $scope.get('OpalConsole').$new()})).$start();
    }, TMP_6.$$arity = -1), nil) && 'run'
  })($scope.base, null);
  return $scope.get('GridgameOpalRunner').$new().$run();
})(Opal);
